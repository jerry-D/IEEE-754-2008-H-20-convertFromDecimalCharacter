...
always @(*)
    if      (FractWeightS0 <= fractPartBin) {FractWeightLTEtotal, FractWeightS1LTEtotal, FractWeightS2LTEtotal} = 3'b100;
    else if (FractWeightS1 <= fractPartBin) {FractWeightLTEtotal, FractWeightS1LTEtotal, FractWeightS2LTEtotal} = 3'b010;   
    else if (FractWeightS2 <= fractPartBin) {FractWeightLTEtotal, FractWeightS1LTEtotal, FractWeightS2LTEtotal} = 3'b001;   

...
always @(*)
    if      (IntWeight   <= integerPartBin) {IntWeightLTEtotal, IntWeightS1LTEtotal, IntWeightS2LTEtotal} = 3'b100;
    else if (IntWeightS1 <= integerPartBin) {IntWeightLTEtotal, IntWeightS1LTEtotal, IntWeightS2LTEtotal} = 3'b010;   
    else if (IntWeightS2 <= integerPartBin) {IntWeightLTEtotal, IntWeightS1LTEtotal, IntWeightS2LTEtotal} = 3'b001;   
